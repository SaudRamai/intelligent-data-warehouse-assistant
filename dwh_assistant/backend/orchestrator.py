...
def run_step(session, step_name: str, requirements: dict, data_profile: dict, current_results: dict, model: str, status_callback=None, last_error=None, force_refresh=False):
...
try:
    ...
    try:
        ...
        def add_script_run_context(*_args, **_kwargs): pass
        def get_script_run_ctx(*_args, **_kwargs): return None
