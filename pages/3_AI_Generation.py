...
def clear_all_generation_caches(steps):
    ...
    other_keys = [
        "architecture_selection", "schema_modeling",
...
def start_generation(steps):
    """Helper to eliminate duplicate logic when starting/resetting generation."""
